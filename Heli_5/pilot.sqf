...
if (player == _driver) then
{
	while {player == _driver} do 
	{
		if (((FhzOfPlayer doorPhase "Door_5_source") == 0) AND ((FhzOfPlayer doorPhase "Door_4_source") == 0)) then
		{
			...
			IDHELI_DOORO = player addAction ["<t color='#FF0911'>Türen öffnen", "Vehicle_Eject\Heli_5\open.sqf"];
			IDHELI_DOOROL = player addAction ["<t color='#000000'>Linke Tür öffnen", "Vehicle_Eject\Heli_5\openl.sqf"];
			IDHELI_DOOROR = player addAction ["<t color='#00FF00'>Rechte Tür öffnen", "Vehicle_Eject\Heli_5\openr.sqf"];
		...
		if (((FhzOfPlayer doorPhase "Door_5_source") == 1) AND ((FhzOfPlayer doorPhase "Door_4_source") == 1)) then
		{
			...
			IDHELI_DOORC = player addAction ["<t color='#FF0911'>Türen schließen", "Vehicle_Eject\Heli_5\close_all.sqf"];
		...
		{
			IDHELI_DOORR = player addAction ["<t color='#00FF00'>Rechte Tür schließen", "Vehicle_Eject\Heli_5\close_r.sqf"];			
		...
		{
			IDHELI_DOORL = player addAction ["<t color='#000000'>Linke Tür schließen", "Vehicle_Eject\Heli_5\close_l.sqf"];
