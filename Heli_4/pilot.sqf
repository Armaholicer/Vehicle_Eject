...
if (player == _driver) then
{
	while {player == _driver} do 
	{
		if (((FhzOfPlayer doorPhase "Door_R") == 0) AND ((FhzOfPlayer doorPhase "Door_L") == 0)) then
		{
			...
			IDHELI_DOOROL = player addAction ["<t color='#000000'>Linke Tür öffnen", "Vehicle_Eject\Heli_4\openl.sqf"];
			IDHELI_DOOROR = player addAction ["<t color='#00FF00'>Rechte Tür öffnen", "Vehicle_Eject\Heli_4\openr.sqf"];
		...
		{
			IDHELI_DOORR = player addAction ["<t color='#FF0911'>Rechte Tür schließen", "Vehicle_Eject\Heli_4\close_r.sqf"];			
		...
		{
			IDHELI_DOORL = player addAction ["<t color='#FF0911'>Linke Tür schließen", "Vehicle_Eject\Heli_4\close_l.sqf"];
